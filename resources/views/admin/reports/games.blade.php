...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-0 fw-bold text-dark">Game Analytics</h4>
        <p class="text-muted mb-0">Track match activity and performance stats</p>
    </div>
    <a href="{{ route('admin.reports.games.export') }}" class="btn btn-danger fw-bold shadow-sm">
