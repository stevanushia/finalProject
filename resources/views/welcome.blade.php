...
<body>
    <div class="ie-panel"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img
                src="{{ asset('assets/images/ie8-panel/warning_bar_0000_us.jpg') }}" height="42" width="820"
    ...
    <div class="page">
                                        ...
                                        <div class="cart-inline-toggled-outer">
                                            ...
                                            <button class="link link-cart cart-inline-toggle"
                                                data-rd-navbar-toggle="#cart-inline"><span
                                                    ...
                                                    class="link-cart-counter">2</span></button>
                                            <!-- Cart Inline-->
                                            <article class="cart-inline cart-inline-toggled" id="cart-inline">
                                                <div class="cart-inline-inner">
                                                    ...
                                                    <div class="cart-inline-main">
                                                        ...
                                                        <article class="product-inline">
                                                            <div class="product-inline-aside"><a
                                                                    class="product-inline-figure" href="#"><img
                                                                        class="product-inline-image"
                                                                        src="{{ asset('assets/images/product-Nike-Air-Zoom-Pegasus-67x30.png') }}"
                                                                        alt="" width="67" height="30" /></a></div>
                                                            <div class="product-inline-main">
                                                                <p class="heading-7 product-inline-title"><a
                                                                        href="#">Nike Air Zoom Pegasus</a></p>
                                                                <ul class="product-inline-meta">
                                                                    <li>
                                                                        <input class="form-input" type="number"
                                                                            data-zeros="true" value="2" min="1"
                                                                            max="100">
                                                                    </li>
                                                                    <li>
                                                        ...
                                                        <article class="product-inline">
                                                            <div class="product-inline-aside"><a
                                                                    class="product-inline-figure" href="#"><img
                                                                        class="product-inline-image"
                                                                        src="{{ asset('assets/images/product-Nike-Baseball-Hat-55x38.png') }}"
                                                                        alt="" width="55" height="38" /></a></div>
                                                            <div class="product-inline-main">
                                                                <p class="heading-7 product-inline-title"><a
                                                                        href="#">Nike Baseball Hat</a></p>
                                                                <ul class="product-inline-meta">
                                                                    <li>
                                                                        <input class="form-input" type="number"
                                                    ...
                                                    <div class="cart-inline-footer"><a
                                                            class="button button-md button-default-outline" href="#">Go
                                                            to Cart</a><a class="button button-md button-primary"
                                                            href="#">Checkout</a></div>
                                                </div>
                                            </article>
                                        </div>
        ...
        <section class="section swiper-container swiper-slider swiper-classic bg-gray-2" data-loop="true"
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide text-center" data-slide-bg="{{ asset('assets/images/slider-1-slide-1-1920x671.jpg') }}">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-6">
                                <div class="swiper-slide-caption">
                                    <h1 data-caption-animate="fadeInUp" data-caption-delay="100">We play Soccer</h1>
                                    <h4 data-caption-animate="fadeInUp" data-caption-delay="200">like no one else in the
                                        united states
                                    </h4><a class="button button-primary" data-caption-animate="fadeInUp"
                                        data-caption-delay="300" href="about-us.html">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide" data-slide-bg="{{ asset('assets/images/slider-1-slide-2-1920x671.jpg') }}">
                    <div class="container">
                        <div class="row justify-content-end">
                            <div class="col-xl-5">
                                <div class="swiper-slide-caption">
                                    <h1 data-caption-animate="fadeInUp" data-caption-delay="100">We Are Pros</h1>
                                    <h4 data-caption-animate="fadeInUp" data-caption-delay="200">in Everything
                                        Concerning Soccer</h4><a class="button button-primary"
                ...
                <div class="swiper-slide" data-slide-bg="{{ asset('assets/images/slider-1-slide-3-1920x671.jpg') }}">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-5">
                                <div class="swiper-slide-caption">
                                    <h1 data-caption-animate="fadeInUp" data-caption-delay="100">Best Website</h1>
                                    <h4 data-caption-animate="fadeInUp" data-caption-delay="200">for soccer news,
                                        updates, <br class="d-none d-xl-block"> and game results</h4><a
                                        class="button button-primary" data-caption-animate="fadeInUp"
                                        data-caption-delay="300" href="about-us.html">Read More</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row row-30">
                                <div class="col-md-6">
                                    ...
                                    <article class="post-future"><a class="post-future-figure" href="#"><img
                                                src="{{ asset('assets/images/news-2-1-368x287.jpg') }}" alt="" width="368" height="287" /></a>
                                        <div class="post-future-main">
                                            <h4 class="post-future-title"><a href="#">Sadio mane still makes a
                                                    difference, sam wilson
                                                    admits</a></h4>
                                            ...
                                            <div class="post-future-text">
                                                <p>Liverpool would love to welcome Philippe Coutinho back, but Sadio
                                                    Mane is carrying...</p>
                                            </div>
                                            <div class="post-future-footer group-flex group-flex-xs"><a
                                                    class="button button-gray-outline" href="#">Read more</a>
                                ...
                                <div class="col-md-6">
                                    <!-- Post Future-->
                                    <article class="post-future"><a class="post-future-figure" href="#"><img
                                                src="{{ asset('assets/images/news-2-2-368x287.jpg') }}" alt="" width="368" height="287" /></a>
                                        <div class="post-future-main">
                                            <h4 class="post-future-title"><a href="#">Robertson's decent debut at
                                                    european cup 2020</a></h4>
                                            <div class="post-future-meta">
                                                <!-- Badge-->
                                                <div class="badge badge-secondary">The Team
                                                </div>
                                            ...
                                            <hr />
                                            <div class="post-future-text">
                                                <p>Robertson, in his first Anfield outing as a Liverpool player, looked
                                                    assured at left-back...
                                                </p>
                                            </div>
                                            <div class="post-future-footer group-flex group-flex-xs"><a
                                                    class="button button-gray-outline" href="#">Read more</a>
                                ...
                                <div class="col-md-6">
                                    <!-- Post Future-->
                                    <article class="post-future"><a class="post-future-figure" href="#"><img
                                                src="{{ asset('assets/images/news-2-3-368x287.jpg') }}" alt="" width="368" height="287" /></a>
                                        <div class="post-future-main">
                                            <h4 class="post-future-title"><a href="#">Pochettino and ‘gaffer’s son’ Rose
                                                    estranged –
                                                    reports</a></h4>
                                            <div class="post-future-meta">
                                                <!-- Badge-->
                                            ...
                                            <hr />
                                            <div class="post-future-text">
                                                <p>Danny Rose and Mauricio Pochettino were once so close that he was
                                                    nicknamed “the gaffer’s...
                                                </p>
                                            </div>
                                            <div class="post-future-footer group-flex group-flex-xs"><a
                                                    class="button button-gray-outline" href="#">Read more</a>
                                ...
                                <div class="col-md-6">
                                    <!-- Post Future-->
                                    <article class="post-future"><a class="post-future-figure" href="#"><img
                                                src="{{ asset('assets/images/news-2-4-368x287.jpg') }}" alt="" width="368" height="287" /></a>
                                        <div class="post-future-main">
                                            <h4 class="post-future-title"><a href="#">Coutinho’s camp: It was all
                                                    Barca’s fault and we can
                                                    prove it</a></h4>
                                            <div class="post-future-meta">
                                                <!-- Badge-->
                                                <div class="badge badge-secondary">The Team
                                            ...
                                            <hr />
                                            <div class="post-future-text">
                                                <p>Philippe Coutinho is reportedly seeking clear-the-air talks with
                                                    Liverpool after...</p>
                                            </div>
                                            <div class="post-future-footer group-flex group-flex-xs"><a
                                                    class="button button-gray-outline" href="#">Read more</a>
                                ...
                                <div class="col-md-12">
                                    <!-- Post Gloria-->
                                    <article class="post-gloria"><img src="{{ asset('assets/images/post-gloria-1-769x429.jpg') }}" alt=""
                                            width="769" height="429" />
                                        <div class="post-gloria-main">
                                            <h3 class="post-gloria-title"><a href="#">Premier League Winners and Losers:
                                                    a quick look</a></h3>
                                ...
                                <div class="col-md-12">
                                    <!-- Post Future-->
                                    <article class="post-future post-future-horizontal"><a class="post-future-figure"
                                            href="#"><img src="{{ asset('assets/images/news-3-1-370x325.jpg') }}" alt="" width="370"
                                                height="325" /></a>
                                        <div class="post-future-main">
                                            <h4 class="post-future-title"><a href="#">Zidane: “We’re not going to change
                                                    the way we play at
                                                    the Calderón”</a></h4>
                                            <div class="post-future-meta">
                                                <!-- Badge-->
                                            ...
                                            <hr />
                                            <div class="post-future-text">
                                                <p>Zidane spoke to the media at the Real Madrid City. The Whites coach
                                                    explained how the team is
                                ...
                                <div class="col-md-12">
                                    <!-- Post Future-->
                                    <article class="post-future post-future-horizontal"><a class="post-future-figure"
                                            href="#"><img src="{{ asset('assets/images/news-3-2-370x325.jpg') }}" alt="" width="370"
                                                height="325" /></a>
                                        <div class="post-future-main">
                                            <h4 class="post-future-title"><a href="#">NFL Will Handle Referee Pete
                                                    Morelli’s Use of Profanity
                                                    Internally</a></h4>
                                            <div class="post-future-meta">
                                                <!-- Badge-->
                                                <div class="badge badge-primary">The League
                                            ...
                                            <hr />
                                            <div class="post-future-text">
                                                <p>The NFL will internally address referee Pete Morelli's recent
                                                    microphone gaffe, a league
                                ...
                                <div class="col-md-12">
                                    <!-- Swiper-->
                                    <div class="swiper-container swiper-slider post-slider" data-loop="false"
                                        data-autoplay="false" data-simulate-touch="false">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="swiper-slide-caption">
                                                    <!-- Post Alice-->
                                                    <article class="post-alice"><img
                                                            src="{{ asset('assets/images/post-slide-1-769x397.jpg') }}" alt="" width="769"
                                                            height="397" />
                                                        <div class="post-alice-main">
                                                            <!-- Badge-->
                                                            <div class="badge badge-secondary">the team
                                                            </div>
                                                            <h3 class="post-alice-title"><a href="#">Lewis named AIG
                                                                    MCAA
                                                                    Sevens head coach</a></h3>
                                                            <div class="divider"></div>
                                                            <div class="post-alice-time"><span
                                            ...
                                            <div class="swiper-slide">
                                                <div class="swiper-slide-caption">
                                                    <!-- Post Alice-->
                                                    <article class="post-alice"><img
                                                            src="{{ asset('assets/images/post-slide-2-769x397.jpg') }}" alt="" width="769"
                                                            height="397" />
                                                        <div class="post-alice-main">
                                                            <!-- Badge-->
                                                            <div class="badge badge-primary">The League
                                                            </div>
                                                            <h3 class="post-alice-title"><a href="#">rumors about world
                                                                    soccer championship 2020</a>
                                                            </h3>
                                                            <div class="divider"></div>
                                                            <div class="post-alice-time"><span
                                                                    class="icon mdi mdi-clock"></span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="swiper-slide-caption">
                                                    <!-- Post Alice-->
                                                    <article class="post-alice"><img
                                                            src="{{ asset('assets/images/post-slide-3-769x397.jpg') }}" alt="" width="769"
                                                            height="397" />
                                                        <div class="post-alice-main">
                                                            <!-- Post Video Button--><a class="post-video-button"
                                                                href="#modal1" data-toggle="modal"><span
                                                                    class="icon material-icons-play_arrow"></span></a>
                                                            <h3 class="post-alice-title"><a href="#">2020 Europa League
                                                                    Final</a></h3>
                                                            <div class="divider"></div>
                                                            <div class="post-alice-time"><span
                                                                    class="icon mdi mdi-clock"></span>
                                ...
                                <div class="col-md-12">
                                    <!-- Post Future-->
                                    <article class="post-future post-future-horizontal"><a class="post-future-figure"
                                            href="#"><img src="{{ asset('assets/images/news-3-3-370x325.jpg') }}" alt="" width="370"
                                                height="325" /></a>
                                        <div class="post-future-main">
                                            <h4 class="post-future-title"><a href="#">Zidane: “We’re not going to change
                                                    the way we play at
                            ...
                            <article class="game-result">
                                <div class="game-info game-info-creative">
                                    ...
                                    <div class="game-info-main">
                                        <div class="game-info-team game-info-team-first">
                                            <figure><img src="{{ asset('assets/images/team-sportland-75x99.png') }}" alt="" width="75"
                                                    height="99" />
                                            </figure>
                                        ...
                                        <div class="game-info-middle game-info-middle-vertical">
                                            <time class="time-big" datetime="2020-04-17"><span class="heading-3">Fri
                                                    19</span> May 2020
                                            </time>
                                            ...
                                            <div class="group-sm">
                                                ...
                                                </div><a class="button button-sm button-primary" href="#">Buy
                                                    tickets</a>
                                            </div>
                                        </div>
                                        <div class="game-info-team game-info-team-second">
                                            <figure><img src="{{ asset('assets/images/team-dream-team-91x91.png') }}" alt="" width="91"
                                                    height="91" />
                                            </figure>
                                ...
                                <div class="game-info-countdown">
                                    <div class="countdown countdown-bordered" data-type="until"
                                        data-time="31 Dec 2020 16:00" data-format="dhms" data-style="short"></div>
                                </div>
                            </article>
                        </div>
                    </div>
                        ...
                        <aside class="aside-components">
                            <div class="aside-component">
                                <div class="owl-carousel-outer-navigation-1">
                                    ...
                                    <!-- Owl Carousel-->
                                    <div class="owl-carousel owl-spacing-1" data-items="1" data-dots="false"
                                        data-nav="true" data-autoplay="true" data-autoplay-speed="4000"
                                        ...
                                        <article class="game-result game-result-creative">
                                            <div class="game-result-main-vertical">
                                                <div
                                                    class="game-result-team game-result-team-horizontal game-result-team-first">
                                                    <figure class="game-result-team-figure"><img
                                                            src="{{ asset('assets/images/team-sportland-31x41.png') }}" alt="" width="31"
                                                            height="41" />
                                                    </figure>
                                                    ...
                                                    <div
                                                        class="game-result-score game-result-score-big game-result-team-win">
                                                        2<span
                                                            class="game-result-team-label game-result-team-label-right">Win</span>
                                                    </div>
                                                </div><span class="game-result-team-divider">VS</span>
                                                <div
                                                    class="game-result-team game-result-team-horizontal game-result-team-second">
                                                    <figure class="game-result-team-figure"><img
                                                            src="{{ asset('assets/images/team-fenix-40x32.png') }}" alt="" width="40"
                                                            height="32" />
                                                    </figure>
                                                    <div class="game-result-team-title">
                                        ...
                                        <article class="game-result game-result-creative">
                                            <div class="game-result-main-vertical">
                                                <div
                                                    class="game-result-team game-result-team-horizontal game-result-team-first">
                                                    <figure class="game-result-team-figure"><img
                                                            src="{{ asset('assets/images/team-bavaria-fc-26x34.png') }}" alt="" width="26"
                                                            height="34" />
                                                    </figure>
                                                    <div class="game-result-team-title">
                                                ...
                                                <div
                                                    class="game-result-team game-result-team-horizontal game-result-team-second">
                                                    <figure class="game-result-team-figure"><img
                                                            src="{{ asset('assets/images/team-athletic-33x30.png') }}" alt="" width="33"
                                                            height="30" />
                                                    </figure>
                                                    <div class="game-result-team-title">
                                ...
                                <div class="list-post-classic">
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/blog-element-1-94x94.jpg') }}" alt="" width="94"
                                                    height="94" /></a></div>
                                        <div class="post-classic-main">
                                            <p class="post-classic-title"><a href="#">Raheem Sterling turns the tide for
                                                    Manchester</a></p>
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/blog-element-2-94x94.jpg') }}" alt="" width="94"
                                                    height="94" /></a></div>
                                        <div class="post-classic-main">
                                            <p class="post-classic-title"><a href="#">Prem in 90 seconds: Chelsea's
                                                    crisis is over!</a></p>
                                            <div class="post-classic-time"><span class="icon mdi mdi-clock"></span>
                                                <time datetime="2020">April 15, 2020</time>
                                            </div>
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/blog-element-3-94x94.jpg') }}" alt="" width="94"
                                                    height="94" /></a></div>
                                        <div class="post-classic-main">
                                            <p class="post-classic-title"><a href="#">Good vibes back at struggling
                                                    Schalke</a></p>
                                            <div class="post-classic-time"><span class="icon mdi mdi-clock"></span>
                                                <time datetime="2020">April 15, 2020</time>
                                            </div>
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/blog-element-4-94x94.jpg') }}" alt="" width="94"
                                                    height="94" /></a></div>
                                        <div class="post-classic-main">
                                            <p class="post-classic-title"><a href="#">Liverpool in desperate need of
                                                    backup players</a></p>
                                            <div class="post-classic-time"><span class="icon mdi mdi-clock"></span>
                                                <time datetime="2020">April 15, 2020</time>
                                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="team-inline">
                                                    <div class="team-figure"><img src="{{ asset('assets/images/team-sportland-31x41.png') }}"
                                            ...
                                            <tr>
                                                <td><span>2</span></td>
                                                <td class="team-inline">
                                                    <div class="team-figure"><img src="{{ asset('assets/images/team-dream-team-34x34.png') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class="team-inline">
                                                    <div class="team-figure"><img
                                                            src="{{ asset('assets/images/team-real-madrid-28x37.png') }}" alt="" width="28"
                                                            height="37" />
                                                    </div>
                                                    <div class="team-title">
                                            ...
                                            <tr>
                                                <td><span>4</span></td>
                                                <td class="team-inline">
                                                    <div class="team-figure"><img src="{{ asset('assets/images/team-celta-vigo-35x39.png') }}"
                                                            alt="" width="35" height="39" />
                                                    </div>
                                                    <div class="team-title">
                                            ...
                                            <tr>
                                                <td><span>5</span></td>
                                                <td class="team-inline">
                                                    <div class="team-figure"><img src="{{ asset('assets/images/team-barcelona-30x35.png') }}"
                                                            alt="" width="30" height="35" />
                                                    </div>
                                                    <div class="team-title">
                                            ...
                                            <tr>
                                                <td><span>6</span></td>
                                                <td class="team-inline">
                                                    <div class="team-figure"><img src="{{ asset('assets/images/team-bavaria-fc-26x34.png') }}"
                                                            alt="" width="26" height="34" />
                                                    </div>
                                                    <div class="team-title">
                            ...
                            <div class="aside-component">
                                ...
                                <div class="owl-carousel owl-carousel-dots-modern awards-carousel" data-items="1"
                                    ...
                                    <div class="awards-item">
                                        ...
                                        <div class="awards-item-aside"> <img src="{{ asset('assets/images/thumbnail-minimal-1-67x147.png') }}"
                                    ...
                                    <div class="awards-item">
                                        ...
                                        <div class="awards-item-aside"> <img src="{{ asset('assets/images/thumbnail-minimal-2-68x126.png') }}"
                                    ...
                                    <div class="awards-item">
                                        ...
                                        <div class="awards-item-aside"> <img src="{{ asset('assets/images/thumbnail-minimal-3-73x135.png') }}"
                                ...
                                <article class="gallery" data-lightgallery="group">
                                    <div class="row row-10 row-narrow">
                                        <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative"
                                                ...
                                                href="{{ asset('assets/images/gallery-soccer-1-original.jpg') }}"><img
                                                    src="{{ asset('assets/images/gallery-soccer-1-212x212.jpg') }}" alt="" />
                                                <div class="thumbnail-creative-overlay"></div>
                                            </a>
                                        </div>
                                        <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative"
                                                data-lightgallery="item"
                                                href="{{ asset('assets/images/gallery-soccer-2-original.jpg') }}"><img
                                                    src="{{ asset('assets/images/gallery-soccer-2-212x212.jpg') }}" alt="" />
                                                <div class="thumbnail-creative-overlay"></div>
                                            </a>
                                        </div>
                                        <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative"
                                                data-lightgallery="item"
                                                href="{{ asset('assets/images/gallery-soccer-3-original.jpg') }}"><img
                                                    src="{{ asset('assets/images/gallery-soccer-3-212x212.jpg') }}" alt="" />
                                                <div class="thumbnail-creative-overlay"></div>
                                            </a>
                                        </div>
                                        <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative"
                                                data-lightgallery="item"
                                                href="{{ asset('assets/images/gallery-soccer-4-original.jpg') }}"><img
                                                    src="{{ asset('assets/images/gallery-soccer-4-212x212.jpg') }}" alt="" />
                                                <div class="thumbnail-creative-overlay"></div>
                                            </a>
                                        </div>
                                        <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative"
                                                data-lightgallery="item"
                                                href="{{ asset('assets/images/gallery-soccer-5-original.jpg') }}"><img
                                                    src="{{ asset('assets/images/gallery-soccer-5-212x212.jpg') }}" alt="" />
                                                <div class="thumbnail-creative-overlay"></div>
                                            </a>
                                        </div>
                                        <div class="col-6 col-sm-4 col-md-6 col-lg-4"><a class="thumbnail-creative"
                                                data-lightgallery="item"
                                                href="{{ asset('assets/images/gallery-soccer-6-original.jpg') }}"><img
                                                    src="{{ asset('assets/images/gallery-soccer-6-212x212.jpg') }}" alt="" />
                                                <div class="thumbnail-creative-overlay"></div>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="block-voting">
                                    <div class="group-md">
                                        ...
                                        <div class="player-voting-item">
                                            <div class="player-voting-item-figure"><img
                                                    src="{{ asset('assets/images/player-5-152x144.jpg') }}" alt="" width="152" height="144" />
                                            ...
                                            <div class="player-voting-item-progress">
                                                <!-- Linear progress bar-->
                                                <article
                                                    class="progress-linear progress-bar-modern progress-bar-modern-red">
                                            ...
                                            <button
                                                class="button button-block button-icon button-icon-left button-primary"
                                                type="button"><span
                                                    class="icon material-icons-thumb_up"></span><span>854
                                                    votes</span></button>
                                        </div>
                                        <!-- Player Voting Item-->
                                        <div class="player-voting-item">
                                            <div class="player-voting-item-figure"><img
                                                    src="{{ asset('assets/images/player-6-152x144.jpg') }}" alt="" width="152" height="144" />
                                                <div class="player-number">
                                                    <p>7</p>
                                                </div>
                                            </div>
                                            ...
                                            <button
                                                class="button button-block button-icon button-icon-left button-primary"
                                                type="button"><span
                                                    class="icon material-icons-thumb_up"></span><span>436
                                                    votes</span></button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="aside-component">
                                <div class="owl-carousel-outer-navigation">
                                    ...
                                    <div class="owl-carousel owl-spacing-1" data-items="1" data-dots="false"
                                        data-nav="true" data-autoplay="true" data-autoplay-speed="4000"
                                        data-stage-padding="0" data-loop="false" data-margin="30"
                                        ...
                                        <article class="product">
                                            <header class="product-header">
                                                ...
                                                <div class="product-figure"><img src="{{ asset('assets/images/shop/product-1.png') }}"
                                                        alt="" /></div>
                                                    ...
                                                    <div class="product-button product-button-share fl-bigmug-line-share27"
                                                        ...
                                                        <ul class="product-share">
                                                            ...
                                                            <li class="product-share-item"><a
                                                                    class="icon fa fa-facebook" href="#"></a></li>
                                                            <li class="product-share-item"><a
                                                                    class="icon fa fa-instagram" href="#"></a></li>
                                                        ...
                                                        class="product-button fl-bigmug-line-zoom60"
                                                        href="{{ asset('assets/images/shop/product-1-original.jpg') }}"
                                                        data-lightgallery="item" style="font-size: 25px"></a>
                                                </div>
                                            </header>
                                            <footer class="product-content">
                                                <h6 class="product-title"><a href="#">Nike hoops elite backpack</a></h6>
                                                <div class="product-price"><span
                                                        class="product-price-old">$400</span><span
                                        ...
                                        <article class="product">
                                            <header class="product-header">
                                                ...
                                                <div class="product-figure"><img src="{{ asset('assets/images/shop/product-2.png') }}"
                                                        alt="" /></div>
                                                <div class="product-buttons">
                                                    <div class="product-button product-button-share fl-bigmug-line-share27"
                                                        style="font-size: 22px">
                                                        ...
                                                        style="font-size: 26px"></a><a
                                                        class="product-button fl-bigmug-line-zoom60"
                                                        href="{{ asset('assets/images/shop/product-2-original.jpg') }}"
                                                        data-lightgallery="item" style="font-size: 25px"></a>
                                                </div>
                                            </header>
                                            <footer class="product-content">
                                        ...
                                        <article class="product">
                                            <header class="product-header">
                                                ...
                                                <div class="product-figure"><img src="{{ asset('assets/images/shop/product-3.png') }}"
                                                        alt="" /></div>
                                                <div class="product-buttons">
                                                    <div class="product-button product-button-share fl-bigmug-line-share27"
                                                        style="font-size: 22px">
                                                        ...
                                                        style="font-size: 26px"></a><a
                                                        class="product-button fl-bigmug-line-zoom60"
                                                        href="{{ asset('assets/images/shop/product-3-original.jpg') }}"
                                                        data-lightgallery="item" style="font-size: 25px"></a>
                                                </div>
                                            </header>
                                            <footer class="product-content">
                                                <h6 class="product-title"><a href="#">Nike distressed baseball hat</a>
                                                </h6>
                                                <div class="product-price"><span
                                                        class="product-price-old">$400</span><span
                                                        class="heading-6 product-price-new">$290</span>
                    ...
                    <div class="row row-50">
                        <div class="col-lg-5 text-center text-sm-left">
                            <article
                                ...
                                <div class="unit-body">
                                    <p>Sportland website offers you the latest news about our team as well as updates on
                                        our matches and
                                        other events.</p>
                                </div>
                            </article>
                            ...
                            <div class="group-md group-middle">
                                ...
                                </div><a class="button button-sm button-gray-outline" href="contact-us.html">Get in
                                    Touch</a>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            ...
                            <div class="row row-20">
                                <div class="col-sm-6">
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/footer-soccer-post-1-93x87.jpg') }}" alt="" width="93"
                                                    height="87" /></a></div>
                                        <div class="post-classic-main">
                                            <!-- Badge-->
                                            <div class="badge badge-secondary">The Team
                                            </div>
                                            <p class="post-classic-title"><a href="#">Bundy stymies Blue Jays and
                                                    Orioles hit 2 HRs</a></p>
                                            <div class="post-classic-time"><span class="icon mdi mdi-clock"></span>
                                                <time datetime="2020">April 15, 2020</time>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/footer-soccer-post-2-93x87.jpg') }}" alt="" width="93"
                                                    height="87" /></a></div>
                                        <div class="post-classic-main">
                                            <!-- Badge-->
                                            <div class="badge badge-red">Hot<span
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/footer-soccer-post-3-93x87.jpg') }}" alt="" width="93"
                                                    height="87" /></a></div>
                                        <div class="post-classic-main">
                                            <!-- Badge-->
                                            <div class="badge badge-primary">The League
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <article class="post-classic">
                                        <div class="post-classic-aside"><a class="post-classic-figure" href="#"><img
                                                    src="{{ asset('assets/images/footer-soccer-post-4-93x87.jpg') }}" alt="" width="93"
                                                    height="87" /></a></div>
                                        <div class="post-classic-main">
                                            <!-- Badge-->
                                            <div class="badge badge-primary">The League
